  ...
  return (
    <div className="py-10 max-w-[480px] px-5 mx-auto flex flex-col gap-6">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <OutlineButton>
          <Plus className="size-4 text-zinc-600" /> Tocar um instrumento
        </OutlineButton>
      </div>
          ...
          <ul className="flex flex-col gap-3">
            <li className="flex items-center gap-2">
              ...
              <span className="text-sm text-zinc-400">
                ...
                às <span className="text-zinc-100">09:00</span>
              </span>
            </li>
            <li className="flex items-center gap-2">
              <CheckCircle2 className="size-4 text-pink-500" />
            ...
            <li className="flex items-center gap-2">
              ...
              <span className="text-sm text-zinc-400">
                Você completou "
                <span className="text-zinc-100">Tocar um instrumento</span>" às{' '}
                <span className="text-zinc-100">21:00</span>
              </span>
            </li>
          </ul>
        </div>
